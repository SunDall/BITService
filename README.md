...
<h5>!Note: html code was only in previous versions of this project. It can be found in trash folder. The main part of the work bases on `JavaScript`</h5>`JavaScript` [![Typing SVG](https://readme-typing-svg.herokuapp.com?color=%2336BCF7&lines=JavaScript)](https://git.io/typing-svg) <h5>only with copability to build the program on Docker</h5>
